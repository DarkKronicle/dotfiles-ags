...
import { ConfigToggle } from '../../common/configwidgets.js';
...
const BluetoothDevice = (device) => {
    ...
    const deviceIcon = Icon({
        className: 'panel-bluetooth-appicon',
        vpack: 'center',
    ...
    const deviceRemoveButton = Button({
        vpack: 'center',
        className: 'panel-bluetooth-device-remove',
    ...
    return Box({
        className: 'panel-bluetooth-device spacing-h-10',
        children: [
            deviceIcon,
            deviceStatus,
            Box({
...
export default (props) => {
    ...
    const deviceList = Overlay({
        ...
        overlays: [Box({
            className: 'panel-centermodules-scrollgradient-bottom'
        })]
    });
    ...
    const bottomBar = Box({
        ...
        children: [Button({
            hpack: 'center',
            className: 'txt-small txt panel-centermodules-bottombar-button',
            onClicked: () => {
                execAsync(['swaymsg', 'exec', 'blueman-manager']).catch(print);
                closeEverything();
            },
            label: 'More',
            setup: setupCursorHover,
