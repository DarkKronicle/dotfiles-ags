...
const WifiNetwork = (accessPoint) => {
    ...
    return Button({
        onClicked: accessPoint.active ? () => { } : () => execAsync(`nmcli device wifi connect ${accessPoint.bssid}`)
            ...
            .catch(print),
        child: Box({
            className: 'panel-wifinetworks-network spacing-h-10',
            children: [
                networkStrength,
                networkName,
                Box({ hexpand: true }),
...
const CurrentNetwork = () => {
    ...
    const networkAuth = Revealer({
        ...
        child: Box({
            ...
            children: [
                ...
                Entry({
                    className: 'panel-wifinetworks-auth-entry',
    ...
    const actualContent = Box({
        ...
        children: [
            Box({
                className: 'panel-wifinetworks-network',
                vertical: true,
                children: [
                    Box({
...
export default (props) => {
    ...
    const bottomBar = Box({
        ...
        children: [Button({
            ...
            onClicked: () => {
                execAsync(['swaymsg', 'exec', 'nm-connection-editor']).catch(print);
                closeEverything();
            },
            label: 'More',
